...
internal class HistoryDeleteDataSingle(rxFit: RxFit, val dataDeleteRequest: DataDeleteRequest, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
