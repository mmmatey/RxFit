...
internal class HistoryRegisterDataUpdateListenerSingle(rxFit: RxFit, pendingIntent: PendingIntent, dataSource: DataSource?, dataType: DataType?, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {

    val request: DataUpdateListenerRegistrationRequest

    init {

        val builder = DataUpdateListenerRegistrationRequest.Builder()
