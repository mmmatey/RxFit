...
internal class HistoryUpdateDataSingle(rxFit: RxFit, val dataUpdateRequest: DataUpdateRequest, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
