...
internal class RecordingSubscribeSingle(rxFit: RxFit, val dataSource: DataSource?, val dataType: DataType?, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
