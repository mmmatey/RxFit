...
internal class RecordingUnsubscribeSingle(rxFit: RxFit, val dataSource: DataSource?, val dataType: DataType?, val subscription: Subscription?, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
