...
internal class SensorsAddDataPointIntentSingle(rxFit: RxFit, val sensorRequest: SensorRequest, val pendingIntent: PendingIntent, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
