...
internal class SessionRegisterSingle(rxFit: RxFit, val pendingIntent: PendingIntent, timeout: Long?, timeUnit: TimeUnit?) : BaseSingle<Status>(rxFit, timeout, timeUnit) {
